...
ALL_PRODUCTS = {
    ...
    "beardo-godfather-beard-oil": ("Beardo Godfather Beard Oil", "Beardo", "Hair Care", 88, "Pure carrier oils, no harmful additives", "Blend of sweet almond, argan and jojoba oils. No mineral oil or silicones."),
    "beardo-beard-wash": ("Beardo Beard Wash", "Beardo", "Hair Care", 65, "Contains mild surfactants and conditioning agents", "Sodium laureth sulphate base with conditioning agents. Contains methylisothiazolinone preservative."),
    "beardo-activated-charcoal-face-wash": ("Beardo Activated Charcoal Face Wash", "Beardo", "Personal Care", 68, "Charcoal-based deep cleansing face wash", "Contains activated charcoal for deep pore cleansing. SLS-based — can be drying with daily use."),
    "beardo-d-tan-face-wash": ("Beardo D-Tan Face Wash", "Beardo", "Personal Care", 65, "Exfoliating de-tanning face wash", "Contains kojic acid and papain enzyme for de-tanning. SLS base may irritate sensitive skin."),
    "beardo-spf50-sunscreen": ("Beardo SPF 50 PA+++ Sunscreen", "Beardo", "Skincare", 70, "Chemical sunscreen with niacinamide", "Contains avobenzone and octinoxate UV filters with niacinamide for brightening. Paraben-free."),
    "beardo-beard-hair-wax": ("Beardo Beard & Hair Wax", "Beardo", "Hair Care", 58, "Styling wax with synthetic polymers", "Contains beeswax, petroleum jelly and synthetic polymers. Strong hold with fragrance."),
    "beardo-hair-serum": ("Beardo Hair Serum", "Beardo", "Hair Care", 65, "Silicone-based hair serum for frizz control", "Contains dimethicone and cyclopentasiloxane for frizz control. Provides temporary smoothing."),
    "beardo-moisturizer": ("Beardo De-Tan SPF 30 Moisturizer", "Beardo", "Skincare", 68, "SPF moisturizer with de-tanning agents", "Contains kojic acid, niacinamide and SPF 30. Paraben-free formula for daily use."),
    "beardo-beard-growth-serum": ("Beardo Beard Growth Serum", "Beardo", "Hair Care", 72, "Beard growth actives with natural oils", "Contains minoxidil-free growth actives: caffeine, biotin and redensyl with carrier oils."),
    "the-ordinary-niacinamide": ("The Ordinary Niacinamide 10% + Zinc 1% Serum", "The Ordinary", "Skincare", 84, "Well-formulated niacinamide serum with zinc", "10% niacinamide with zinc PCA; targets pores, excess oil and uneven tone. No parabens or silicones."),
    "the-ordinary-hyaluronic-acid": ("The Ordinary Hyaluronic Acid 2% + B5", "The Ordinary", "Skincare", 86, "Excellent multi-molecular hydrating serum", "Three weights of HA with panthenol (B5) for surface and deep hydration. Clean, minimal formula."),
    "the-ordinary-aha-bha-peeling": ("The Ordinary AHA 30% + BHA 2% Peeling Solution", "The Ordinary", "Skincare", 62, "Very strong acid exfoliant — use with caution", "30% glycolic + lactic acids with 2% salicylic acid. Strong — 10 min max, avoid sensitive skin."),
    "the-ordinary-vitamin-c-suspension": ("The Ordinary Vitamin C Suspension 23% + HA Spheres 2%", "The Ordinary", "Skincare", 70, "High-potency pure ascorbic acid suspension", "23% L-ascorbic acid — most potent but least stable form. May tingle on first use. Store cool."),
    "the-ordinary-retinol": ("The Ordinary Retinol 0.5% in Squalane", "The Ordinary", "Skincare", 72, "Mid-strength retinol in stable squalane base", "0.5% retinol in squalane base — reduces irritation. Use SPF, avoid pregnancy. Start slow."),
    "the-ordinary-buffet-serum": ("The Ordinary Buffet Multi-Technology Serum", "The Ordinary", "Skincare", 82, "Multi-peptide serum targeting multiple signs of ageing", "Contains Matrixyl 3000, Argireline, HA, amino acids and probiotics. Comprehensive anti-ageing."),
    "the-ordinary-natural-moisturizing": ("The Ordinary Natural Moisturizing Factors + HA", "The Ordinary", "Skincare", 85, "Excellent basic moisturiser with skin-identical ingredients", "Amino acids, hyaluronic acid, ceramides and urea — mirrors skin's own NMF. No parabens."),
    "the-ordinary-squalane-cleanser": ("The Ordinary Squalane Cleanser", "The Ordinary", "Skincare", 84, "Gentle balm-to-milk cleanser with squalane", "Squalane base with plant-derived ester. Melts makeup without stripping. No SLS, no parabens."),
    "the-ordinary-lactic-acid": ("The Ordinary Lactic Acid 10% + HA", "The Ordinary", "Skincare", 74, "Gentle exfoliating serum suitable for beginners", "10% lactic acid (gentler than glycolic) for brightening and mild exfoliation. With HA for hydration."),
    "minimalist-zinc-face-wash": ("Minimalist Zinc + Niacinamide Face Wash", "Minimalist", "Skincare", 76, "SLS-free cleanser for acne-prone skin", "Zinc PCA and niacinamide base; no SLS, no parabens. Gentle enough for twice-daily use."),
    "minimalist-tranexamic-acid": ("Minimalist Tranexamic Acid 3% Serum", "Minimalist", "Skincare", 78, "Brightening serum safe for all skin tones", "Tranexamic acid 3% reduces hyperpigmentation and dark spots. Works well alongside niacinamide."),
    "minimalist-squalane": ("Minimalist Squalane 100%", "Minimalist", "Skincare", 92, "Pure plant-derived squalane — excellent skin-identical oil", "100% plant-derived squalane from sugarcane. Non-comedogenic, lightweight, no additives."),
    "minimalist-mandelic-acid": ("Minimalist Mandelic Acid 10% Face Serum", "Minimalist", "Skincare", 74, "Gentle AHA exfoliant ideal for sensitive skin", "Mandelic acid is the gentlest AHA due to large molecular size. Good for sensitive and dark skin."),
    "minimalist-omega-water-cream": ("Minimalist Omega Water Cream Moisturizer", "Minimalist", "Skincare", 82, "Lightweight barrier-repair moisturizer with omega fatty acids", "Omega 3, 6, 9 fatty acids with ceramides and niacinamide. Gel-cream texture, paraben-free."),
    "minimalist-sunscreen-spf50-spray": ("Minimalist SPF 50 PA++++ Invisible Sunscreen Spray", "Minimalist", "Skincare", 72, "Lightweight spray sunscreen for reapplication", "Alcohol-based spray for easy reapplication; UV filters with no white cast. Avoid inhaling spray."),
    "ustraa-beard-oil": ("Ustraa Beard Oil", "Ustraa", "Hair Care", 86, "Natural oil blend for beard conditioning", "Blend of argan, jojoba, almond and vitamin E oils. No mineral oil or synthetic additives."),
    "ustraa-face-wash-oily": ("Ustraa Face Wash for Oily Skin", "Ustraa", "Personal Care", 68, "Oil-control face wash with charcoal", "Contains activated charcoal and neem extract; SLS base. Effective oil control for men."),
    "ustraa-hair-wax": ("Ustraa Hair Wax", "Ustraa", "Hair Care", 58, "Medium-hold styling wax", "Contains beeswax, lanolin and synthetic polymers. Strong fragrance with hold agents."),
    "ustraa-anti-dandruff-shampoo": ("Ustraa Anti Dandruff Shampoo", "Ustraa", "Hair Care", 65, "Zinc pyrithione anti-dandruff shampoo", "Contains zinc pyrithione (1%) and mint; SLS base. Effective dandruff control."),
    "ustraa-deo-spray": ("Ustraa After Dark Deo Spray", "Ustraa", "Personal Care", 60, "Alcohol-based deo spray", "Contains alcohol and synthetic fragrance blend. Standard deodorant spray."),
    "bsc-charcoal-face-wash": ("Bombay Shaving Company Activated Charcoal Face Wash", "Bombay Shaving Company", "Personal Care", 70, "Charcoal face wash with salicylic acid", "Contains activated charcoal, salicylic acid and niacinamide. SLS-free; good for acne-prone skin."),
    "bsc-shaving-cream": ("Bombay Shaving Company Shaving Cream", "Bombay Shaving Company", "Personal Care", 72, "Rich shaving cream with natural ingredients", "Contains aloe vera, sandalwood and coconut oil. No parabens or artificial dyes."),
    "bsc-beard-oil": ("Bombay Shaving Company Beard Oil", "Bombay Shaving Company", "Hair Care", 86, "Natural multi-oil beard conditioner", "Jojoba, argan, sweet almond and castor oil blend. No mineral oil, no silicones."),
    "bsc-after-shave-lotion": ("Bombay Shaving Company After Shave Lotion", "Bombay Shaving Company", "Personal Care", 68, "Soothing after shave with aloe vera", "Contains aloe vera, witch hazel and allantoin. Contains alcohol — may irritate sensitive skin."),
    "bsc-sunscreen": ("Bombay Shaving Company SPF 50 PA+++ Sunscreen", "Bombay Shaving Company", "Skincare", 72, "Lightweight sunscreen for men", "Hybrid UV filters with niacinamide and vitamin E. Non-greasy, paraben-free."),
    "old-spice-swagger-deo": ("Old Spice Swagger Deodorant Body Spray", "Old Spice", "Personal Care", 58, "Alcohol-based deo with synthetic fragrance", "Contains alcohol (isobutane, butane propellant) and synthetic fragrance. Standard deodorant."),
    "old-spice-after-shave": ("Old Spice Original After Shave Lotion", "Old Spice", "Personal Care", 62, "Classic after shave with alcohol and fragrance", "Contains SD alcohol (40%), water, fragrance and allantoin. Antimicrobial but drying on skin."),
    "old-spice-body-wash": ("Old Spice Swagger Body Wash", "Old Spice", "Personal Care", 64, "Moisturising body wash with mild surfactants", "Contains sodium laureth sulphate and cocamidopropyl betaine. Moisturising with glycerin."),
    "gillette-mach3-shaving-gel": ("Gillette Mach3 Sensitive Shaving Gel", "Gillette", "Personal Care", 68, "Sensitive skin shaving gel", "Contains glycerin, aloe vera and vitamin E. Free of alcohol and synthetic dyes."),
    "gillette-fusion-shaving-foam": ("Gillette Fusion Ultra-Sensitive Shaving Foam", "Gillette", "Personal Care", 66, "Moisturising shaving foam with aloe", "Contains aloe vera and glycerin with isobutane propellant. Suitable for sensitive skin."),
    "gillette-after-shave-balm": ("Gillette Series After Shave Balm", "Gillette", "Personal Care", 68, "Non-alcohol after shave balm", "Alcohol-free formula with vitamin E, aloe vera and allantoin. Soothes post-shave irritation."),
    "park-avenue-deo": ("Park Avenue Beer Shampoo Deo Spray", "Park Avenue", "Personal Care", 58, "Deo spray with synthetic fragrance", "Contains isobutane propellant and synthetic fragrance blend. Standard deodorant spray."),
    "park-avenue-after-shave": ("Park Avenue Deo After Shave", "Park Avenue", "Personal Care", 60, "After shave with alcohol and fragrance", "Contains alcohol and fragrance. Standard after shave with light moisturising effect."),
    "park-avenue-hair-cream": ("Park Avenue Grooming Hair Cream", "Park Avenue", "Hair Care", 60, "Styling hair cream with hold polymers", "Contains PVP polymer, glycerin and fragrance. Light to medium hold for styling."),
    "brylcreem-original": ("Brylcreem Original Hair Styling Cream", "Brylcreem", "Hair Care", 58, "Classic petroleum-based hair cream", "Contains mineral oil and petrolatum with fragrance. Provides light hold and shine."),
    "brylcreem-anti-dandruff": ("Brylcreem Anti-Dandruff Hair Cream", "Brylcreem", "Hair Care", 62, "Styling cream with zinc pyrithione", "Contains zinc pyrithione for dandruff control with light styling hold."),
    "axe-pulse-body-wash": ("Axe Pulse Body Wash", "Axe", "Personal Care", 62, "Body wash with synthetic fragrance", "Contains sodium laureth sulphate and synthetic fragrance. Standard body wash."),
    "axe-recharge-deo": ("Axe Recharge Ice Chill Deo Spray", "Axe", "Personal Care", 58, "Aerosol deo with alcohol and synthetic fragrance", "Contains isobutane and butane propellants with synthetic fragrance. Standard deo spray."),
    "axe-signature-deo": ("Axe Signature Absolute Deo Bodyspray", "Axe", "Personal Care", 58, "Body spray with synthetic fragrance", "Contains denatured alcohol and synthetic fragrance. No aluminium salts."),
    "pilgrim-aha-face-wash": ("Pilgrim AHA BHA Face Wash", "Pilgrim", "Skincare", 74, "Mild AHA-BHA exfoliating cleanser", "Contains glycolic acid (AHA) and salicylic acid (BHA); no SLS, no parabens."),
    "pilgrim-spf60-sunscreen": ("Pilgrim SPF 60 PA+++ Invisible Sunscreen", "Pilgrim", "Skincare", 74, "High-SPF invisible sunscreen", "Hybrid UV filters with zinc oxide and chemical filters. No white cast, paraben-free."),
    "earth-rhythm-vitamin-c-serum": ("Earth Rhythm 15% Vitamin C Serum", "Earth Rhythm", "Skincare", 76, "Stable vitamin C brightening serum", "Contains 15% ascorbyl glucoside (stable vitamin C) with ferulic acid and HA. Vegan, paraben-free."),
    "earth-rhythm-sunscreen": ("Earth Rhythm SPF 50 PA++++ Tinted Sunscreen", "Earth Rhythm", "Skincare", 76, "Tinted mineral-chemical hybrid sunscreen", "Zinc oxide and chemical UV filters; iron oxide pigments for blue light protection. No parabens."),
    "just-herbs-face-wash": ("Just Herbs Ayurvedic Face Wash", "Just Herbs", "Skincare", 78, "Gentle herbal face wash with Ayurvedic actives", "Contains neem, tulsi, turmeric and chandan. SLS-free, paraben-free, herbal formulation."),
    "mcaffeine-coffee-shower-gel": ("MCaffeine Coffee De-Tan Body Wash", "MCaffeine", "Personal Care", 74, "Coffee and vitamin C body wash", "Contains coffee extract, vitamin C and kojic acid for de-tanning. No SLS, no parabens."),
    "the-moms-co-sunscreen": ("The Moms Co Natural Sunscreen SPF 30", "The Moms Co", "Skincare", 80, "Mineral-only zinc oxide sunscreen", "100% zinc oxide sunscreen — safe for babies and sensitive skin. No chemical UV filters."),
    "plum-goodness-green-tea-face-wash": ("Plum Goodness Green Tea Pore Cleansing Face Wash", "Plum", "Skincare", 76, "Green tea face wash for oily skin", "Contains green tea and glycolic acid; SLS-free. 100% vegan, no parabens."),
    "sugar-cosmetics-face-wash": ("SUGAR Cosmetics Citrus Got Real Face Wash", "Sugar Cosmetics", "Skincare", 72, "Vitamin C face wash with citrus extracts", "Contains vitamin C and citrus extracts; SLS-free, mild formula. Vegan and cruelty-free."),
    "wow-retinol-serum": ("WoW Skin Science Retinol Serum", "Wow Skin Science", "Skincare", 70, "Retinol serum for anti-ageing", "Contains retinol with vitamin E and hyaluronic acid. Use SPF; avoid in pregnancy."),
